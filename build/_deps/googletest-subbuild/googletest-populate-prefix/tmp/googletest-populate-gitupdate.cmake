...
function(do_fetch)
  ...
  execute_process(
    COMMAND "C:/msys64/usr/bin/git.exe" --git-dir=.git fetch --tags --force "origin"
...
function(get_hash_for_ref ref out_var err_var)
  execute_process(
    COMMAND "C:/msys64/usr/bin/git.exe" --git-dir=.git rev-parse "${ref}^0"
    WORKING_DIRECTORY "C:/Users/olegt/Desktop/nsu-oop-labs/build/_deps/googletest-src"
...
execute_process(
  COMMAND "C:/msys64/usr/bin/git.exe" --git-dir=.git show-ref "release-1.12.1"
  WORKING_DIRECTORY "C:/Users/olegt/Desktop/nsu-oop-labs/build/_deps/googletest-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: release-1.12.1")
    return()
  endif()
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"release-1.12.1\" is not present locally, and not "
...
if(git_update_strategy MATCHES "^REBASE(_CHECKOUT)?$")
  ...
  execute_process(
    COMMAND "C:/msys64/usr/bin/git.exe" --git-dir=.git symbolic-ref -q HEAD
    WORKING_DIRECTORY "C:/Users/olegt/Desktop/nsu-oop-labs/build/_deps/googletest-src"
  ...
  if(current_branch STREQUAL "")
    ...
    execute_process(
      COMMAND "C:/msys64/usr/bin/git.exe" --git-dir=.git for-each-ref "--format=%(upstream:short)" "${current_branch}"
      WORKING_DIRECTORY "C:/Users/olegt/Desktop/nsu-oop-labs/build/_deps/googletest-src"
...
execute_process(
  COMMAND "C:/msys64/usr/bin/git.exe" --git-dir=.git status --porcelain
  WORKING_DIRECTORY "C:/Users/olegt/Desktop/nsu-oop-labs/build/_deps/googletest-src"
  RESULT_VARIABLE error_code
...
if(need_stash)
  execute_process(
    COMMAND "C:/msys64/usr/bin/git.exe" --git-dir=.git stash save --quiet;--include-untracked
    WORKING_DIRECTORY "C:/Users/olegt/Desktop/nsu-oop-labs/build/_deps/googletest-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  execute_process(
    COMMAND "C:/msys64/usr/bin/git.exe" --git-dir=.git checkout "${checkout_name}"
    WORKING_DIRECTORY "C:/Users/olegt/Desktop/nsu-oop-labs/build/_deps/googletest-src"
    COMMAND_ERROR_IS_FATAL ANY
    ${maybe_show_command}
  )
  ...
  execute_process(
    COMMAND "C:/msys64/usr/bin/git.exe" --git-dir=.git rebase "${checkout_name}"
    WORKING_DIRECTORY "C:/Users/olegt/Desktop/nsu-oop-labs/build/_deps/googletest-src"
    RESULT_VARIABLE error_code
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "C:/msys64/usr/bin/git.exe" --git-dir=.git rebase --abort
      WORKING_DIRECTORY "C:/Users/olegt/Desktop/nsu-oop-labs/build/_deps/googletest-src"
      ${maybe_show_command}
    )
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      if(need_stash)
        execute_process(
          COMMAND "C:/msys64/usr/bin/git.exe" --git-dir=.git stash pop --index --quiet
          WORKING_DIRECTORY "C:/Users/olegt/Desktop/nsu-oop-labs/build/_deps/googletest-src"
          ${maybe_show_command}
          )
      endif()
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/olegt/Desktop/nsu-oop-labs/build/_deps/googletest-src'."
    ...
    execute_process(
      COMMAND "C:/msys64/usr/bin/git.exe" --git-dir=.git tag -a
...
if(need_stash)
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "C:/msys64/usr/bin/git.exe" --git-dir=.git reset --hard --quiet
      WORKING_DIRECTORY "C:/Users/olegt/Desktop/nsu-oop-labs/build/_deps/googletest-src"
      ${maybe_show_command}
    )
    execute_process(
      COMMAND "C:/msys64/usr/bin/git.exe" --git-dir=.git stash pop --quiet
      WORKING_DIRECTORY "C:/Users/olegt/Desktop/nsu-oop-labs/build/_deps/googletest-src"
      RESULT_VARIABLE error_code
      ${maybe_show_command}
    )
    if(error_code)
      ...
      execute_process(
        COMMAND "C:/msys64/usr/bin/git.exe" --git-dir=.git reset --hard --quiet ${head_sha}
        WORKING_DIRECTORY "C:/Users/olegt/Desktop/nsu-oop-labs/build/_deps/googletest-src"
        ${maybe_show_command}
      )
      execute_process(
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/olegt/Desktop/nsu-oop-labs/build/_deps/googletest-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
